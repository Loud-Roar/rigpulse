...
app = FastAPI(title="RigPulse", version="0.4.7")
...
.solo-odds{margin-top:7px;color:#8fa4bb;font-size:11px}.solo-odds b{color:#70d8ff}.solopool-strip{margin-top:10px;padding:12px 14px;display:grid;grid-template-columns:auto repeat(2,minmax(0,1fr));gap:12px;align-items:stretch}.solopool-item{min-width:0;color:#8fa4bb;font-size:11px;background:rgba(5,16,29,.62);border:1px solid rgba(var(--accent-rgb),.18);border-radius:11px;padding:11px 13px}.solopool-item>b{color:#a9bdd2;font-size:11px}.solopool-title{font-weight:800;display:flex;align-items:center}.solopool-hash{font-size:clamp(20px,2vw,27px);font-weight:900;color:#5fc8ff;margin:5px 0 3px;line-height:1}.solopool-item.bch .solopool-hash{color:#d576ff}.solopool-stats{display:flex;gap:7px 12px;flex-wrap:wrap;margin-top:5px}.solopool-stats span{white-space:nowrap}.solopool-stats b{color:#fff}.pool-miner-card .hash{color:#5fc8ff}.pool-miner-card.bch .hash{color:#d576ff}
...
@media(max-width:1100px){.metrics{grid-template-columns:repeat(3,1fr)}.grid{grid-template-columns:repeat(2,1fr)}}
