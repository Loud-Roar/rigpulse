...
app = FastAPI(title="RigPulse", version="0.3.0")
...
@media(max-width:720px){.app{display:block}.sidebar{height:auto;position:relative;display:flex;align-items:center;padding:10px}.nav{display:none}.brand{margin:0}.main{padding:12px}.metrics{grid-template-columns:1fr 1fr}.grid{grid-template-columns:1fr}.stats{grid-template-columns:repeat(2,1fr)}}
</style>
</head>
<body>
