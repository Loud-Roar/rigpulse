...
This release adds persistent miner block-found celebrations, replay controls,
BTC/BCH network status, current-share telemetry, and watch-only wallet balances.
...
```text
ghcr.io/loud-roar/rigpulse:0.4.0
```
