...
This release fixes SHA-256 miner diagnostics and lets users close popup dialogs
by clicking the shaded area outside the panel.
...
```text
ghcr.io/loud-roar/rigpulse:0.3.7
```
