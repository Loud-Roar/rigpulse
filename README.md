...
This release adds pool-side BCH SoloPool block detection and winning-worker
matching when miner firmware does not report found blocks.
...
```text
ghcr.io/loud-roar/rigpulse:0.4.1
```
